...
def preprocess(folder, filename):
    ...
    ref1 = np.where(a["Transaction Ref1"].isna(), "", a["Transaction Ref1"])
    ref2 = np.where(a["Transaction Ref2"].isna(), "", a["Transaction Ref2"])
    ref3 = np.where(a["Transaction Ref3"].isna(), "", a["Transaction Ref3"])

    a["Description"] = ref1
    a["Description"] = np.where(a["Description"] != "", a["Description"], ref2)
    a["Description"] = np.where(a["Description"] != "", a["Description"], ref3)


    a["Notes"] = np.where(a["Transaction Ref1"] == a["Description"], ref2+ref3, ref3)
